/*! UIkit 3.0.2 custom build by https://ar-themes.blogspot.com | http://www.getuikit.com | (c) 2014 - 2018 YOOtheme | MIT License */
...
.uk-list:not(.uk-list-inline)>li:nth-child(n+2), .uk-list:not(.uk-list-inline)>li>ul {
	margin-top: 10px
}
...
.uk-input:focus, .uk-input:hover, .uk-select:focus, .uk-select:hover, .uk-textarea:focus, .uk-textarea:hover {
	outline: 0;
...
.uk-button-danger:disabled, .uk-button-default:disabled, .uk-button-primary:disabled, .uk-button-secondary:disabled, .uk-button-success:disabled, .uk-button-warning:disabled {
	background-color: transparent;
	color: #999;
	border-color: #e5e5e5
}
...
.uk-totop:active, .uk-totop:focus, .uk-totop:hover {
	background: #0056b3;
	border-color: #0056b3;
	color: #fff;
	outline: 0
...
.horizontal_tabs, .vertical_tabs {
	border: 1px solid #eee;
	border-radius: 4px;
	box-shadow: 0 5px 15px rgba(0, 0, 0, .08)
}
.horizontal_tabs .uk-tab {
	margin-bottom: 0
}
.horizontal_tabs .uk-tab li a {
	padding: 12px 0
}
.horizontal_tabs .uk-switcher {
	overflow: hidden;
	margin: 0!important;
	padding: 25px 30px
}
.vertical_tabs .uk-switcher {
	padding: 25px 30px
}
.uk-tab .uk-dropdown {
	margin-right: 40px
...
.uk-accordion-title:focus::before, .uk-accordion-title:hover::before {
	background-image: url("data:image/svg+xml;charset=UTF-8,%3Csvg%20width%3D%2213%22%20height%3D%2213%22%20viewBox%3D%220%200%2013%2013%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%0A%20%20%20%20%3Crect%20fill%3D%22%23fff%22%20width%3D%2213%22%20height%3D%221%22%20x%3D%220%22%20y%3D%226%22%20%2F%3E%0A%20%20%20%20%3Crect%20fill%3D%22%23fff%22%20width%3D%221%22%20height%3D%2213%22%20x%3D%226%22%20y%3D%220%22%20%2F%3E%0A%3C%2Fsvg%3E")
}
.uk-open>.uk-accordion-title:focus::before, .uk-open>.uk-accordion-title:hover::before {
	background-image: url("data:image/svg+xml;charset=UTF-8,%3Csvg%20width%3D%2213%22%20height%3D%2213%22%20viewBox%3D%220%200%2013%2013%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%0A%20%20%20%20%3Crect%20fill%3D%22%23fff%22%20width%3D%2213%22%20height%3D%221%22%20x%3D%220%22%20y%3D%226%22%20%2F%3E%0A%3C%2Fsvg%3E")
}
